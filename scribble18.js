...
//	$('#dTrans').get(0).addEventListener('click', function(e) { disableTranparency();}, false);
	...
	$('#scatRect').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "squareBrush"; otherTools = "noTool";/*pencilDraw = false; scatRect = true; drawRect = false; spray2Paint = false; drawLine = false;  drawCirc = false; drawSelect = false;/* rectTool();*/}, false);
	$('#scatCirc').get(0).addEventListener('click', function(e) { lastTool = "notbackground"; brushSelect = "circleBrush"; otherTools = "noTool";/*pencilDraw = false; scatRect = false; scatCirc = true; spray2Paint = false; drawRect = false; drawLine = false; drawCirc = false; drawSelect = false;/* rectTool();*/}, false);
	$('#paint').get(0).addEventListener('click', function(e) { lastTool = "notbackground"; brushSelect = "pencil"; otherTools = "noTool";/*pencilDraw = true; scatRect = false; drawLine = false; spray2Paint = false; scatCirc = false; drawCirc = false; drawSelect = false;*/}, false);
	...
	$('#spray2').get(0).addEventListener('click', function(e) { lastTool = "notbackground"; brushSelect = "spray2"; otherTools = "noTool";/*pencilDraw = false; scatRect = false; scatCirc = false; sprayPaint = false; spray2Paint = true; drawRect = false; drawLine = false; drawCirc = false; drawSelect = false;/* rectTool();*/}, false);
	$('#lBrush').get(0).addEventListener('click', function(e) {lastTool = "notbackground";  brushSelect = "lineBrush"; otherTools = "noTool";/*enableDraw = false;/*pencilDraw = false; scatRect = false; scatCirc = false; sprayPaint = false; spray2Paint = false; calPen=true; drawRect = false; drawLine = false; drawCirc = false; drawSelect = false;/* rectTool();*/}, false);
	$('#cHatch').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "crossHatch"; otherTools = "noTool";}, false);
	$('#eraser').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "eraser"; otherTools = "noTool";}, false);
	$('#fPen').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "fountainPen"; otherTools = "noTool";}, false);
	$('#pen3').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "pen3"; otherTools = "noTool";}, false);
	$('#pen4').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "pen4"; otherTools = "noTool";}, false);
	$('#pen5').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "pen5"; otherTools = "noTool";}, false);
	$('#NP1').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "NP1"; otherTools = "noTool";}, false);
	$('#NP2').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "NP2"; otherTools = "noTool";}, false);
	$('#rect').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "noBrush"; otherTools = "rect";/*rectTool(); *//*pencilDraw = false; sprayPaint = false; spray2Paint = false; scatRect = false; scatCirc = false; drawRect = true; drawSelect = false; moveTool = false; copyTool = false; deleteTool = false;*/}, false);
	$('#circ').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "noBrush"; otherTools = "circ";/*rectTool(); pencilDraw = false; enableDraw == false; sprayPaint = false; spray2Paint = false; scatRect = false; scatCirc = false; drawRect = false; drawCirc = true; drawSelect = false; moveTool = false; copyTool = false; deleteTool = false;*/}, false);
	$('#line').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "noBrush"; otherTools = "line";/*rectTool(); pencilDraw = false; sprayPaint = false; spray2Paint = false; scatRect = false; scatCirc = false; drawRect = false; drawCirc = false; drawLine = true; drawSelect = false; moveTool = false; copyTool = false; deleteTool = false;*/}, false);
	$('#qCurve').get(0).addEventListener('click', function(e) {lastTool = "notbackground"; brushSelect = "noBrush"; otherTools = "qCurve";/*rectTool(); pencilDraw = false; sprayPaint = false; spray2Paint = false; scatRect = false; scatCirc = false; drawRect = false; drawCirc = false; drawLine = false; drawQCurve = true; drawSelect = true; moveTool = false; copyTool = false; deleteTool = false;*/}, false);
